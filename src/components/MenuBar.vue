<template>
    ...
    >
      <div class="sidebar-header flex items-center justify-center py-4">
        <div class="inline-flex">
          <a href="#" class="inline-flex flex-row items-center">
            ...
            <span class="leading-10 text-gray-100 text-2xl font-bold ml-1 uppercase">Navegacion</span>
          </a>
        </div>
      </div>
      <div class="sidebar-content px-2 py-4 flex flex-col gap-10 ">
        ...
        <div>
          <ul>
            <span class="flex font-medium text-md  text-gray-300  uppercase">Opciones</span>
          <li class="my-px">
            <a
        ...
        <div>
          <ul>
            <span class="flex font-medium text-md text-gray-300  uppercase">Constancias</span>   
          <li class="my-px">
            <a
              href="/titulo"
              class="flex flex-row items-center h-10 px-3 rounded-lg text-gray-300 hover:bg-gray-100 hover:text-gray-700"
          ...
          <div>
          <ul>
            <span class="flex font-medium text-md text-gray-300  uppercase">Cuenta</span>
          <li class="my-px">
            <a
              href="/cuenta"
              class="flex flex-row items-center h-10 px-3 rounded-lg text-gray-300 hover:bg-gray-100 hover:text-gray-700"
